...
class digiwallet_bw extends digiwalletpayment
{
    ...
    public function prepareTransaction()
    {
        ...
        $objDigiCore->setReportUrl(DigiWalletCore::formatOscommerceUrl(tep_href_link('ext/modules/payment/digiwallet/callback.php', '', 'SSL') . '?checksum=1&type=' . $this->config_code));
        ...
        tep_redirect(DigiWalletCore::formatOscommerceUrl(tep_href_link("bankwire_success.php?trxid=" . $this->transactionID, '', 'SSL', true, false)));
        exit(0);
    }
}
