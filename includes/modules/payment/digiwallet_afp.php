...
class digiwallet_afp extends digiwalletpayment
{
    ...
    public function prepareTransaction()
    {
        ...
        $objDigiCore->setReturnUrl(DigiWalletCore::formatOscommerceUrl(tep_href_link('ext/modules/payment/digiwallet/callback.php', '', 'SSL') . '?finished=1&type=' . $this->config_code));
        $objDigiCore->setReportUrl(DigiWalletCore::formatOscommerceUrl(tep_href_link('ext/modules/payment/digiwallet/callback.php', '', 'SSL') . '?type=' . $this->config_code));
        $objDigiCore->setCancelUrl(DigiWalletCore::formatOscommerceUrl(tep_href_link('ext/modules/payment/digiwallet/callback.php', '', 'SSL') . '?cancel=1&type=' . $this->config_code));
        ...
        if ($result === false) {
            ...
            tep_redirect(DigiWalletCore::formatOscommerceUrl(tep_href_link(FILENAME_CHECKOUT_PAYMENT, 'error_message=' . urlencode($this->getConstant("MODULE_PAYMENT_DIGIWALLET_" . $this->config_code . "_ERROR_TEXT_ERROR_OCCURRED_PROCESSING") . " " . $objDigiCore->getErrorMessage()), 'SSL', true, false)));
            exit(0);
        }
        ...
        if (strtolower($status) != "captured") {
            ...
            if (strtolower($status) == "rejected") {
                ...
                tep_redirect(DigiWalletCore::formatOscommerceUrl(tep_href_link(FILENAME_CHECKOUT_PAYMENT, 'error_message=' . urlencode($this->getConstant("MODULE_PAYMENT_DIGIWALLET_" . $this->config_code . "_ERROR_TEXT_ERROR_OCCURRED_PROCESSING") . " " . $ext_info), 'SSL', true, false)));
                exit(0);
            } else {
